 ...
 * @author WARLOCK
 */
public class PronunciationAccuracyChecker {

    private static final Integer AVERAGE_PRONUNCIATION_ACCURACY = 60;

    public static boolean isAccuratePronunciation(int pronunciationAccuracy) {
        return pronunciationAccuracy >= AVERAGE_PRONUNCIATION_ACCURACY;
    }

    public static int checkAccuracy(String s, String t) {
