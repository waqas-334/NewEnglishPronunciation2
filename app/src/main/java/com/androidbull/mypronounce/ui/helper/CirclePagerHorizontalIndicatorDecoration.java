...
public class CirclePagerHorizontalIndicatorDecoration extends RecyclerView.ItemDecoration {
    ...
    public CirclePagerHorizontalIndicatorDecoration(List<HasAccuracy> itemList) {
